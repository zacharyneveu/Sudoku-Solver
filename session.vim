...
silent only
cd C:\Users\Zachary\GoogleDrive\Documents\Algorithms\Algo_P4
...
exe 'vert 2resize ' . ((&columns * 110 + 113) / 226)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
let s:l = 40 - ((26 * winheight(0) + 31) / 63)
...
375
normal! zo
let s:l = 379 - ((56 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
379
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 22 - ((2 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
